        ...
        <>
            ...
            <Box bg={'#fff'} p={['1em' , '2em']} borderRadius={'0.5em'} cursor={'pointer'} onClick = { onOpen }>
                ...
                <Flex color={'grey'} justifyContent={'space-between'}>
                    <Box display={'flex'} gap={'0.5em'} alignItems={'center'} color={'gray'}>
                        <BiTime/> 

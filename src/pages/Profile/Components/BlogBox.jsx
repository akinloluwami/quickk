...
const BlogBox = ({ blogTitle , blogBrief  }) => {
    ...
    return (
        <>
            ...
            <Box bg={'#fff'}  width={['100%','100%']} my={'1em'} p={['1em' , '2em']} borderRadius={'1em'}>
                ...
                <Box >
                   ...
                   <Box my={'1em'}>
                        ...
                        <Text my={'1em'}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime doloribus nam sapiente debitis laborum omnis, </Text>
